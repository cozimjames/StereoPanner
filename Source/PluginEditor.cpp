    ...
    : AudioProcessorEditor(p), processor(p)
{
    ...
    startTimer(200);//starts timeer with intercal of 200mS
    //[/Constructor]
}
...
void StereoPannerAudioProcessorEditor::resized()
{
    ...
    sliderPanPosition->setBounds (16, 16, 128, 104);
...
<JUCER_COMPONENT documentType="Component" className="StereoPannerAudioProcessorEditor"
  ...
  <SLIDER name="new slider" id="4c0bfe730ac2d426" memberName="sliderPanPosition"
          virtualName="" explicitFocusOrder="0" pos="16 16 128 104" min="-1"
